...
chrome.storage.sync.get([
  ...
  (score)=> {
    let displayArr = []
    let storeInfo = [
      {section: 'women', pageSection: womenSection, sectionScore: score.womenPageScore},
      {section: 'men', pageSection: menSection, sectionScore: score.menPageScore},
      {section: 'home', pageSection: homeSection, sectionScore: score.homePageScore},
      {section: 'lifeStyle', pageSection: lifeStyleSection, sectionScore: score.lifeStylePageScore},
      {section: 'beauty', pageSection: beautySection, sectionScore: score.beautyPageScore},
    ]
